...
5.  Independent variable should be categorical with at least 2 levels
...
# For these examples we will be looking at the treatment and pain scale
# The categorical variable will be treatment while the independent variable while 
# pain-score will be the dependent variable
